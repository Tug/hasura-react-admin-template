...
ALTER TABLE public.users ADD COLUMN "organization_id" integer DEFAULT 1 NOT NULL;
...
CREATE TABLE public.model_types (
    ...
    name text NOT NULL,
    description text,
    train_params_schema json,
    generate_params_schema json,
    evaluate_params_schema json
);
...
ALTER TABLE ONLY public.models
    ADD CONSTRAINT models_type_fkey FOREIGN KEY (type_id) REFERENCES public.model_types(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.organization_models
