declare module 'ra-data-hasura' {
	...
	export const customBuildFields: CustomBuildFields;
	...
	type BuildGqlQueryOverrides<T = any> = {
	...
	export default function (
		options?: Options,
		buildGqlQueryOverrides?: BuildGqlQueryOverrides,
		customBuildVariables?: BuildVariables,
		customGetResponseParser?: ResponseParser,
	): Promise<
		(f: FetchType, r: ResourceType, params: object) => { data: any }
	>;
}
